...
# less
export LESS='-FJR '
export SYSTEMD_LESS='-iFJMRS --mouse'
export LESSHISTFILE='-'
...
for map in emacs viins; do
    ...
    bindkey -M $map $key_map[Control]E end-of-line
    bindkey -M $map $key_map[Control]A beginning-of-line 
...
fpath=(
    ...
    $XDG_CONFIG_HOME/zsh/plugins/zsh-completions/src
    $fpath
) 
autoload -U $fpath[1]/*
...
source $XDG_CONFIG_HOME/zsh/plugins/lf-icons.zsh
...
ZSH_HIGHLIGHT_STYLES[bracket-level-2]='fg=orange,bold'
ZSH_HIGHLIGHT_STYLES[bracket-level-3]='fg=yellow,bold'
ZSH_HIGHLIGHT_STYLES[bracket-level-4]='fg=magenta,bold'
ZSH_HIGHLIGHT_STYLES[bracket-error]='bg=red,fg=white,bold'
ZSH_HIGHLIGHT_STYLES[icursor-matchingbracket]='fg=green,bold'
...
source $XDG_CONFIG_HOME/zsh/plugins/zsh-history-substring-search/zsh-history-substring-search.plugin.zsh
